...
android {
    ...
    signingConfigs {
        getByName("debug") {
            storeFile = file("tuneo-debug.keystore")
...
dependencies {
    ...
    // Supabase (backend : auth, base de données, storage, temps réel)
    ...
    // Ktor (client HTTP requis par le SDK Supabase sur Android ; supabase-kt 3.x exige Ktor 3.x)
